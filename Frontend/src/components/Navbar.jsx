...
function Navbar() {
  ...
  // UseEffect for sticky navbar on scroll
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 0) {
        setSticky(true);
  ...
  return (
    <>
      <div
        className={`mx-auto fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white ${
          sticky ? "bg-base-200 transition-all ease-in-out shadow-md" : ""
        }`}
      >
